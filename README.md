...
* **[Latest release](https://github.com/erykjj/jwpublib/releases/tag/Cnc_5.3)**: *Cnc_4.2* & *Cnc_5.3* — [English](https://github.com/erykjj/jwpublib/releases/download/Cnc_5.3/Cnc_5.3_E.jwpub)&nbsp;[<img src="screenshots/qr.png" width="16px">](https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://github.com/erykjj/jwpublib/releases/download/Cnc_5.3/Cnc_5.3_E.jwpub), [French](https://github.com/erykjj/jwpublib/releases/download/Cnc_5.3/Cnc_4.2_F.jwpub)&nbsp;[<img src="screenshots/qr.png" width="16px">](https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://github.com/erykjj/jwpublib/releases/download/Cnc_5.3/Cnc_4.2_F.jwpub), [Italian](https://github.com/erykjj/jwpublib/releases/download/Cnc_5.3/Cnc_5.3_I.jwpub)&nbsp;[<img src="screenshots/qr.png" width="16px">](https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://github.com/erykjj/jwpublib/releases/download/Cnc_5.3/Cnc_5.3_I.jwpub), [Polish](https://github.com/erykjj/jwpublib/releases/download/Cnc_5.3/Cnc_5.3_P.jwpub)&nbsp;[<img src="screenshots/qr.png" width="16px">](https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://github.com/erykjj/jwpublib/releases/download/Cnc_5.3/Cnc_5.3_P.jwpub), [Portuguese (Brazil)](https://github.com/erykjj/jwpublib/releases/download/Cnc_5.3/Cnc_4.2_T.jwpub)&nbsp;[<img src="screenshots/qr.png" width="16px">](https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://github.com/erykjj/jwpublib/releases/download/Cnc_5.3/Cnc_4.2_T.jwpub), [Spanish](https://github.com/erykjj/jwpublib/releases/download/Cnc_5.3/Cnc_5.3_S.jwpub)&nbsp;[<img src="screenshots/qr.png" width="16px">](https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://github.com/erykjj/jwpublib/releases/download/Cnc_5.3/Cnc_5.3_S.jwpub)
* **Released**: [2025-05-25](CHANGELOG.md/#cnc_53---2025-05-25)
* **Note**: For now, English, Italian, Polish and Spanish have the Appendix categiories ("full" version - v5.3); French and Portuguese are v4.2 (concordance only). See below…
* **Traslations**: If interested in adding another language to the "appendix club", please [let me know](https://github.com/erykjj/jwpublib/discussions/71)
