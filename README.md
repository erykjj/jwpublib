...
Simply download the "Latest release" and **tap/double-click the downloaded file** (on Windows, you can also drag and drop the file into the "Library" section of the JW Library app). It will appear in the **"Guidelines"** section (*Library* → *DOWNLOADED* → *Guidelines*).
...
* [*KJV* and *Strong's* Inline/Interlinear](#kjv-and-strongs-interlinear)    **NEW FORMAT available**
...
* **Latest releases**: [*KJS_3.0-inline.jwpub*](https://github.com/erykjj/jwpublib/releases/download/KJS_3.0/KJS_3.0-inline.jwpub) & [*KJS_3.0-interlinear.jwpub*](https://github.com/erykjj/jwpublib/releases/download/KJS_3.0/KJS_3.0-interlinear.jwpub)
* **Released**: [2024-05-08](CHANGELOG.md/#kjs_30---2024-05-08)
